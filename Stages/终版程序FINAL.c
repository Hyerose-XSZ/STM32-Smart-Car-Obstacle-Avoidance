...
// 1. ??????????? (??320??,???????) —— ??????
// =========================================================
#define SPEED_BASE           350    // ????????
#define SPEED_CURVE_MIN       90    // ???????? (????????)
#define SPEED_DROP_RATE       55    // ?????? (???????????)
...
// ???????? 200 ??
#define AVOID_SPEED_RUN      250    // ???????? (200??)
#define AVOID_SPEED_FAST     460    // ?????????
#define AVOID_SPEED_SLOW      80    // ??1???? (???????????)
#define AVOID_SPEED_LEFT_IN   150    // ??3??????

// ???? 200 ??????
#define TIME_TURN_RIGHT      220    // ??1:??????????? (ms)
#define TIME_FORWARD_PASS    160    // ??2:?????????? (ms)
#define TIME_TURN_LEFT       490    // ??3:?????????? (ms)
#define TIME_PULL_STRAIGHT   380    // ??5:??????????? (ms)
